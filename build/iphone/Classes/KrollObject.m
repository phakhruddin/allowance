...
//@interface allowanceObject : NSObject
//@end

@interface allowanceObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[allowanceObject class]])
		{
			for (NSString *key in [[(allowanceObject*)o modules] allKeys])
			{
