...
@interface allowanceObject : KrollCoverageObject {
#else
@interface allowanceObject : KrollObject {
#endif
@private
...
extern NSString * allowance$ModuleRequireFormat;
