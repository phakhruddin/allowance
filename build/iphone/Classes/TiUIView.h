...
/**
 Base class for all allowance views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the allowance view hierarchy (such as wrapped iOS UIViews) was touched.
