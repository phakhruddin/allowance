...
// in simulator we redefine to format for allowance Developer console
...
{\
	NSString * exceptionName = [@"org.allowance." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.allowance";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIallowanceNativeItemNone = -1, 
	UIallowanceNativeItemSpinner = -2,
	UIallowanceNativeItemProgressBar = -3,
	
	UIallowanceNativeItemSlider = -4,
	UIallowanceNativeItemSwitch = -5,
	UIallowanceNativeItemMultiButton = -6,
	UIallowanceNativeItemSegmented = -7,
	
	UIallowanceNativeItemTextView = -8,
	UIallowanceNativeItemTextField = -9,
	UIallowanceNativeItemSearchBar = -10,
	
	UIallowanceNativeItemPicker = -11,
	UIallowanceNativeItemDatePicker = -12,
	
	UIallowanceNativeItemInfoLight = -13,
	UIallowanceNativeItemInfoDark = -14,
	
	UIallowanceNativeItemDisclosure = -15,
	
	UIallowanceNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all allowance instances of
